...
\begin{ganttchart}[
  ...
  \ganttbar[name=elem1]{Design}{2}{3} \\
  \ganttbar[name=elem2]{Implementierung}{4}{7} \\
  \ganttmilestone[name=Sprint1Ende]{Sprint 1 Ende}{7} \\[grid]
